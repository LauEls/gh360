...
def generate_launch_description():
    ...
    package_name = 'gh360'
    xacro_file_path = os.path.join(get_package_share_directory(package_name), 'urdf', 'gh360.urdf.xacro')
    rviz_config_file_path = os.path.join(get_package_share_directory(package_name), 'rviz', 'urdf_2.rviz')
