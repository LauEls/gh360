...
void gh360::EncoderHandler::shoulder_encoder_callback(const std_msgs::msg::String::SharedPtr msg)
{
    ...
    {
        this->shoulder_joint_angles[i] = (joint_angles[this->shoulder_port_ids[i]-1] + this->shoulder_offsets[i]) * this->shoulder_inverters[i];
    }
...
void gh360::EncoderHandler::upperarm_encoder_callback(const std_msgs::msg::String::SharedPtr msg)
{
    ...
    {
        this->upperarm_joint_angles[i] = (joint_angles[this->upperarm_port_ids[i]-1] + this->upperarm_offsets[i]) * this->upperarm_inverters[i];
    }
...
void gh360::EncoderHandler::lowerarm_encoder_callback(const std_msgs::msg::String::SharedPtr msg)
{
    ...
    {
        this->lowerarm_joint_angles[i] = (joint_angles[this->lowerarm_port_ids[i]-1] + this->lowerarm_offsets[i]) * this->lowerarm_inverters[i];
    }
...
void gh360::EncoderHandler::timer_callback()
{
    ...
    for (uint i=0; i<this->shoulder_joint_names.size(); i++)
    {
        ...
        arm_encoder_msg.current_joint_angles.push_back(joint_encoder_msg);
    }
