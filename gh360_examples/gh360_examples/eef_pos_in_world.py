...
class EEFPos(Node):
    ...
    def timer_callback(self):
        ...
        try:
            self.trans_eef_base = self.tf_buffer.lookup_transform(to_frame_rel, from_frame_rel, rclpy.time.Time())
        ...
        eef_base_pose = tf2_geometry_msgs.do_transform_pose(eef_pose, self.trans_eef_base)
        ...
        self.get_logger().info("EEF Pos in base_link frame: "+str(eef_base_pose.position))
